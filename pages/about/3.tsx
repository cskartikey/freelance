  ...
  return (
    <>
      ...
      <div className="absolute left-1/2 top-1/2 h-[85vh] max-h-[600px] w-[65vw] max-w-[1000px] -translate-x-1/2 -translate-y-1/2 opacity-50">
        <div className="rect-abt3-l aboslute z-0 ml-44 mt-20 h-36 w-56 rounded-md border-2 border-solid border-rectangle-purp"></div>
        <div className="rect-abt3-r absolute left-0 top-36 z-0 h-[400px] w-[700px] rounded-md border-2 border-solid border-rectangle-purp"></div>
        <div className="rect-abt3-r2 absolute right-0 top-0 z-0 h-[400px] w-[700px] rounded-md border-2 border-solid border-rectangle-purp"></div>
