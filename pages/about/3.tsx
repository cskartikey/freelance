...
import { faLaptopCode, faMobileAndroid,} from "@fortawesome/free-solid-svg-icons";
            ...
            <section>
                <div className='flex flex-col gap-10 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 md:max-w-[700px] z-50'>
                    <div className='flex flex-row gap-3 justify-center space-x-2'>
                        <FontAwesomeIcon icon={faLaptopCode} className='text-rectangle-purp text-5xl' />
                        <FontAwesomeIcon icon={faMobileAndroid} className='text-rectangle-purp text-5xl' />
                    </div>
